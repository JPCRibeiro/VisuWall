      ...
      >
        ...
        <form action={signOut}>
          <DropdownMenuItem asChild>
            <button
              type="submit"
              className="w-full flex items-center text-red-400 focus:bg-zinc-800 focus:text-red-400 cursor-pointer select-none rounded-sm px-2 py-1.5 text-sm outline-none transition-colors"
            >
