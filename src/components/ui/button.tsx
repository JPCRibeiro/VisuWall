...
const buttonVariants = cva(
  "cursor-pointer focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 rounded-[8px] border focus-visible:ring-[3px] aria-invalid:ring-[3px] [&_svg:not([class*='size-'])]:size-4 whitespace-nowrap transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none shrink-0 [&_svg]:shrink-0 outline-none group/button select-none",
  {
    variants: {
      variant: {
        ...
        primary: "shadow-sm px-[18px]! py-[6px]! h-auto! bg-white! font-semibold text-background text-[16px]! bg-linear-to-r from-[#03e3b8] to-[#3AEDE3] border-none shadow-[0_3px_0_#028b71] active:translate-y-[2px] active:shadow-none transition-all duration-150",
