  ...
  return (
    <>
      {visibleWallpapers.map((wp) => (
        <Link key={wp.id} href={`/wp/${wp.key}`} className="block">
...
export default function Home() {
  return (
    <>
      ...
      <Header />
      <main>
        <div className="relative overflow-hidden mb-10 mt-16.25">
          <div className="relative container mx-auto px-4 pt-12">
            ...
            <div className="flex justify-center gap-5 mb-10 flex-wrap">
              <Link
                href={"/wallpapers"}
                className="w-30 h-30 bg-[#181818]/70 p-4 rounded-[6px] border border-[#2a2a2a] shadow-md shadow-black/20 flex flex-col justify-center items-center gap-2 text-[#B4B4B4] hover:text-[#03e3b8] transition-colors duration-200 font-medium"
              >
                <Wallpaper size={26} />
                Wallpapers
              </Link>
              <Link
                href={"/favoritos"}
                className="w-30 h-30 bg-[#181818]/75 p-4 rounded-[6px] border border-[#2a2a2a] shadow-md shadow-black/20 flex flex-col justify-center items-center gap-2 text-[#B4B4B4] hover:text-[#03e3b8] transition-colors duration-200 font-medium"
              >
                <Star size={26} />
                Favoritos
              </Link>
